 ...
 */
export async function d10Roll({ terms = [], data = {}, event = {}, rollMode = null, template = "systems/thewitcher/templates/chat/roll.hbs", title = null, speaker = null, flavor = null, dialogOptions = {}, targetValue = null, chatMessage = true, messageData = {}, templateData = {
    roll: Roll,
} }) {
    ...
    if (roll && chatMessage)
        await roll.toMessage(messageData, messageOptions);
    return roll;
}
