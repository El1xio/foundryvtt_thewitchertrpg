...
export default class WitcherActor extends Actor {
    ...
    _prepareDerivedAbilities(actorData, npc = false) {
        const data = actorData.data;
    ...
    _getSkillValue(abilityId, skillId, with_ability = false) {
        const skillData = getProperty(this.data, `data.skills.${abilityId}.${skillId}`);
        if (with_ability)
            return skillData.total;
     ...
     */
    rollAbility(abilityId, options = {}, templateData = {}) {
     ...
     * @param options               Options which configure how ability tests are rolled
     */
    rollSkill(abilityId, skillId, options = {}, templateData = {}) {
     ...
     * @param templateData
     */
    rollProfessionSkill(main, treeId = null, skillId = null, options = {}, templateData = {}) {
